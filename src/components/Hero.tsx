...
export default function Hero() {
  return (
    <>
      <section
        id="home"
        className="flex items-center justify-center w-screen mb-40 mt-44 "
      >
        ...
        <div className=" flex flex-col-reverse items-center justify-center mx-auto md:flex-row  md:space-x-5 z-[1]">
          <div className="container flex flex-col items-center justify-center my-8 text-center space-y-7 md:space-y-9 lg:space-y-12 ">
            ...
            <Link
              ...
              btn-hover-animation"
              href={
                "https://drive.google.com/file/d/14Of-l1NVJU35AAT2SvMlF760HzeVGN2_/view?usp=sharing"
              }
              target="_blank"
            >
              Download Resume
            ...
            <div className="relative flex space-x-12 text-2xl !mt-24  ">
              <Link
                ...
                href={"https://www.facebook.com/JimamFB/"}
                target="_blank"
              >
                <FaFacebook />
              </Link>
              <Link
                className="hover:text-blue-700 transition-all hover:scale-[1.15] duration-300 active:scale-95 active:text-blue-400"
                href={"https://github.com/Jimam-Tamimi"}
                target="_blank"
              >
                <FaGithub />
              </Link>
              <Link
                className="hover:text-blue-700 transition-all hover:scale-[1.15] duration-300 active:scale-95 active:text-blue-400"
                href={"https://www.youtube.com/@Jimam"}
                target="_blank"
              >
                <FaYoutube />
              </Link>
              <Link
                className="hover:text-blue-700 transition-all hover:scale-[1.15] duration-300 active:scale-95 active:text-blue-400"
                href={"https://www.linkedin.com/in/jimam-tamimi-6b5a72324/"}
                target="_blank"
              >
                <FaLinkedin />
              </Link>
              <Link
                className="hover:text-blue-700 transition-all hover:scale-[1.15] duration-300 active:scale-95 active:text-blue-400"
                href={"https://www.instagram.com/jimam_tamimi/"}
                target="_blank"
              >
                <FaInstagram />
              </Link>
